              ...
              <div className="inline-block w-full max-w-xl p-6 my-8 overflow-hidden text-left align-middle transition-all transform bg-white shadow-xl rounded-2xl">
                ...
                <div className='flex flex-row'>
                  <div className="basis-2/4 m-1">
                    ...
                    <input className='my-2 p-2 border-2 rounded-md bg-slate-200 disabled:opacity-75' id='startPrice' onChange={inputHandler} placeholder='Start Price' />
                    <input className='my-2 p-2 border-2 rounded-md bg-slate-200 disabled:opacity-75' id='buyItNowPrice' onChange={inputHandler} placeholder='Buy it Now Price' />
                  ...
                  <div className="basis-2/4 m-1">
                    <p className='mt-12 text-gray-700 text-base'>{errorMessage}</p>
                    {orderPreview ?
