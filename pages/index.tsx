...
const Home: NextPage = () => {
  ...
  const { orders, setFilterType, updateOrders } = useOrdersContext()
  ...
  const { claim, cancelOrder } = useDexContract()
    ...
    <div>
      ...
      {orders.length == 0 ? <div className="flex flex-col items-center justify-center">
        ...
        <main className='flex flex-wrap' >
          <FilterMenu setFilterType={setFilterType}/>
      ...
      {isMakeOfferOpen ?
        <MakeOffer
          ...
          orderInfo={{ order: orders[offerInfo.orderIndex], offerType: offerInfo.offerType }} />
        : null}
